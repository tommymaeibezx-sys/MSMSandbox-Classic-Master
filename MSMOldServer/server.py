        ...
        async for message in client.listen():
            ...
            if message.action == SysAction.HANDSHAKE:
                ...
                if cmd == "db_gene":
                    ...
                    if code == "132026":
                        worked = client.player.add_properties(999_999_999, 999_999_999, 999_999_999, 999_999_999)
                    ...
                    time_delta_ms = current_time_ms - last_collection
                    ...
                    client.player.add_properties(collected, 0, 0, 0)
                    cur_player.execute(
                    ...
                    response.put_bool("success", True)
                    response.put_long("user_monster_id", user_monster_id)
                    response.put_int("coins", collected)
                    await send_extension_response(client, cmd, response)
                    ...
                    update_response.put_int("collected_coins", collected)
